...
$router->get('categories/edit/{id}', [App\Controllers\CategoryController::class, 'edit']);
$router->post('categories/update/{id}', [App\Controllers\CategoryController::class, 'update']);
$router->get('categories/destroy/{id}', [App\Controllers\CategoryController::class, 'destroy']);
